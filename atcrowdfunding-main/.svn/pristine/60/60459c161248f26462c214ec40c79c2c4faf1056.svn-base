	...
	<script src="${APP_PATH}/jquery/layer/layer.js"></script>
        <script type="text/javascript">
            ...
            $("#lefttoRight").click(function(){
            	 ...
            	 var leftlist=$("#leftlist :selected");
            	 var loadIndex=-1 ;
           ...
           $.ajax({
        	   ...
        	   data:dataObj,
         	   berfore:function (){
        	  var loadIndex = layer.msg("正在分配角色...", {time:1000}); 
        	  return true;
        	   },
        	   success:function(result){
        		   layer.close(loadIndex);
        		   if(result.success){
        			 $("#rightlist").append(leftlist.clone());
                  	 leftlist.remove();
                     layer.msg("分配角色成功", {time:1000, icon:6}); 
        		   }else{
        			   layer.msg("分配角色失败", {time:1000, icon:5}); 
        		   }
        	   },
           error:function(){
        	   layer.msg("分配角色失败", {time:1000, icon:5}); 
            ...
            $("#Righttoleft").click(function(){
            	 var rightlist=$("#rightlist :selected");
            	 var loadIndex=-1 ;
            	 ...
            	 $.ajax({
              	   ...
              	   data:dataObj,
              	   berfore:function (){
              	  var loadIndex = layer.msg("正在取消分配角色...", {time:1000}); 
              	  return true;
              	   },
              	   success:function(result){
              		   layer.close(loadIndex);
