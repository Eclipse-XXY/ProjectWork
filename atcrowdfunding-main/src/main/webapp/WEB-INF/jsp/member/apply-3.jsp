...
#footer {
 ...
 <div class="navbar-wrapper">
      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" id="authcode"class="form-control" id="exampleInputEmail1" placeholder="请输入你邮箱中接收到的验证码">
		  </div>
          <button type="button" onclick="javascript:;" class="btn btn-primary">重新发送验证码</button>
		  <button type="button"id="btnfinsh"  class="btn btn-success">申请完成</button>
		</form>
		<hr>
    </div> <!-- /container -->
	...
	<script src="${PATH}/jquery/layer/layer.js"></script>
	<script>
        ...
        $.ajax({	
        	...
        	url:"${APP_PATH}/member/dofinsh.do",
