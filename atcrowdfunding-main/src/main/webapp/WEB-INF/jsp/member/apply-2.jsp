      ...
      <div class="page-header">
		...
		<form role="form" style="margin-top:20px;">
		  <div class="form-group">
			...
			<input type="text" id="femail" value="${sessionScope.loginMember.email }"class="form-control" id="exampleInputEmail1" placeholder="请输入用于接收验证码的邮箱地址">
		  </div>
        ...
        $("#nextbtn").click(function(){
        	$.ajax({
        		...
        		success:function(result){
        			if(result.success){
        			window.location.href="${APP_PATH}/member/authemail.htm"	
        			}else{
