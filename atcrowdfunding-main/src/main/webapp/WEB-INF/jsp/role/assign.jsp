	...
	<SCRIPT type="text/javascript">
		...
		var setting = {
		   ...
		   async: {
		      ...
		      //这个地方的controller地方可以在permission里面写也可以在role里面写但是考虑到时许可树的回显所以写在
		      //permissioncontroller里面比较好
		        url:"${APP_PATH}/permission/asyncLoadData.do?roleid=${role.id}", //异步加载许可树-分配许可
		...
		$("#rolePermissionAssign").click(function(){
			...
			var nodes = treeObj.getCheckedNodes(true); // 获取被选中的所有节点
