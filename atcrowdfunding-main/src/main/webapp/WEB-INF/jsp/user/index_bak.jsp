...
<!--                 status这个表示一条记录的索引保存在里面 
注意使用“”双引号引起来的el表达式是前面不可以有空格-->
			  ...
			  <tfoot>
			     ...
			     <tr >
				     <td colspan="6" align="center">
						...
						<c:if test="${page.pageNo !=1}">
							<li ><a href="#" onclick="pageChange(${requestScope.page.pageNo-1})">上一页</a></li>
						</c:if>
						...
						<c:if test="${page.pageNo!= page.totalNo }">
							<li ><a href="#" onclick="pageChange(${requestScope.page.pageNo+1})">下一页</a></li>
						</c:if>
						<c:if test="${page.pageNo==page.totalNo } ">
	...
	<script src="${APP_PATH}/script/docs.min.js"></script>
        <script type="text/javascript">
            ...
            function pageChange(pageNo){
            	window.location.href="${APP_PATH}/user/index.htm?pageNo="+pageNo;
            }
        </script>
  </body>
</html>
